...
class __TwigTemplate_d6d9b2df259e74c3630092062ffdd41c9dd6561be79db6d8f97f08be510ca1c1 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_integer_widget($context, array $blocks = [])
    {
        ...
        ";
        // line 3
        $context["type"] = (((isset($context["type"]) || array_key_exists("type", $context))) ? (_twig_default_filter((isset($context["type"]) || array_key_exists("type", $context) ? $context["type"] : (function () { throw new RuntimeError('Variable "type" does not exist.', 3, $this->source); })()), "number")) : ("number"));
        // line 4
        echo "        ";
...
";
    ...
    {
        return array (  68 => 4,  66 => 3,  63 => 2,  44 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("{% block integer_widget %}
    <div class=\"integer_widget\">
        {% set type = type|default('number') %}
        {{ block('form_widget_simple') }}
    </div>
{% endblock %}", "form/fields.html.twig", "C:\\xampp\\htdocs\\HMIN302_symfony_blog\\templates\\form\\fields.html.twig");
    }
}
