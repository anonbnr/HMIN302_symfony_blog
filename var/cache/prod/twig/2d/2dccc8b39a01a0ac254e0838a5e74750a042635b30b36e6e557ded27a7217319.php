...
class __TwigTemplate_b86b3ca3f73c3082e2faa1f9e1449b039d09e53260445bbec8c2e5c195c0463f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        <small>published: ";
            // line 12
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["post"], "publicationDate", [], "any", false, false, false, 12), "format", [0 => "d/m/Y"], "method", false, false, false, 12), "html", null, true);
            echo "</small>
        <p>";
            // line 13
            echo twig_escape_filter($this->env, (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "getContent", [], "method", false, false, false, 13)) > 50)) ? ((twig_slice($this->env, twig_get_attribute($this->env, $this->source, $context["post"], "getContent", [], "method", false, false, false, 13), 0, 50) . "...")) : (twig_get_attribute($this->env, $this->source, $context["post"], "getContent", [], "method", false, false, false, 13))), "html", null, true);
            echo "</p>
        <a href=\"";
            // line 14
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("post_show", ["slug" => twig_get_attribute($this->env, $this->source, $context["post"], "getSlug", [], "method", false, false, false, 14)]), "html", null, true);
...
";
    ...
    {
        return array (  109 => 16,  101 => 14,  97 => 13,  93 => 12,  88 => 11,  84 => 10,  81 => 9,  75 => 7,  73 => 6,  66 => 5,  53 => 3,  36 => 1,);
    }
