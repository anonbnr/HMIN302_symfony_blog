...
return [
    false, // $matchHost
    [ // $staticRoutes
        '/admin/post/new' => [[['_route' => 'post_new', '_controller' => 'App\\Controller\\AdminPostController::new'], null, ['GET' => 0, 'POST' => 1], null, false, false, null]],
    ...
    [ // $dynamicRoutes
        35 => [[['_route' => 'post_edit', '_controller' => 'App\\Controller\\AdminPostController::edit'], ['slug'], ['GET' => 0, 'POST' => 1], null, false, false, null]],
        48 => [[['_route' => 'post_delete', '_controller' => 'App\\Controller\\AdminPostController::delete'], ['slug'], ['DELETE' => 0], null, false, false, null]],
        70 => [[['_route' => 'post_show', '_controller' => 'App\\Controller\\PostController::show'], ['slug'], ['GET' => 0], null, false, true, null]],
        106 => [[['_route' => 'fos_user_registration_confirm', '_controller' => 'fos_user.registration.controller:confirmAction'], ['token'], ['GET' => 0], null, false, true, null]],
        136 => [
